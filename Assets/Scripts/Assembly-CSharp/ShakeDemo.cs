		...
		private void OnGUI()
	{
		...
		if (this.showList)
		{
			...
			foreach (CameraShakeInstance cameraShakeInstance2 in CameraShaker.Instance.ShakeInstances)
			{
				...
				GUILayout.Label("      Position Influence: " + cameraShakeInstance2.PositionInfluence, new GUILayoutOption[0]);
				GUILayout.Label("      Rotation Influence: " + cameraShakeInstance2.RotationInfluence, new GUILayoutOption[0]);
