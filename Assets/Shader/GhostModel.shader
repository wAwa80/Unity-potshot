Shader "Ghost/Model" {
	Properties {
		...
		_FresnelCol ("FresnelCol", Vector) = (0.5,0.5,0.5,1)
		_Diffuse ("Diffuse", 2D) = "white" {}
		_GlowInt ("GlowInt", Float) = 1
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  highp vec4 tmpvar_9;
					  tmpvar_9.xyz = ((pow (
					    (1.0 - max (0.0, dot (tmpvar_5, normalize(
					      (_WorldSpaceCameraPos - xlv_TEXCOORD1.xyz)
					    ))))
					  , _Fresnel) * _FresnelCol.xyz) + ((
					    (_Diffuse_var_3.xyz * _Color.xyz)
					   * 
					    clamp ((dot (lightDirection_4, tmpvar_5) + _GlowInt), 0.0, 1.0)
					  ) * _LightColor0.xyz));
					  tmpvar_9.w = _Color.w;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat3.x = dot(u_xlat16_2.xyz, u_xlat1.xyz);
					    u_xlat3.x = u_xlat3.x + _GlowInt;
					    ...
					    u_xlat10_1.xyz = texture(_Diffuse, u_xlat6.xy).xyz;
					    u_xlat1.xyz = u_xlat10_1.xyz * _Color.xyz;
					    u_xlat3.xyz = u_xlat3.xxx * u_xlat1.xyz;
					    u_xlat3.xyz = u_xlat3.xyz * _LightColor0.xyz;
					    SV_Target0.xyz = u_xlat0.xxx * _FresnelCol.xyz + u_xlat3.xyz;
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  tmpvar_9.w = 0.0;
					  tmpvar_9.xyz = (((
					    ((_Diffuse_var_3.xyz * _Color.xyz) * clamp ((dot (
					   ...
					   * _LightColor0.xyz) * attenuation_4) * _Color.w);
					  finalRGBA_2 = tmpvar_9;
					  tmpvar_1 = finalRGBA_2;
					  gl_FragData[0] = tmpvar_1;
					}
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = vec3(u_xlat10_6) * u_xlat0.xyz;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					   ...
					   * 
					    ...
					    ), normalize(xlv_TEXCOORD2)) + _GlowInt), 0.0, 1.0)
					  ) * _LightColor0.xyz) * _Color.w);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					   ...
					   * _LightColor0.xyz) * (
					    (float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_4.w)
					   * tmpvar_7.w)) * _Color.w);
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_3.xyz = texture(_Diffuse, u_xlat3.xy).xyz;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_1 = texture(_LightTexture0, vs_TEXCOORD3.xyz).w;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat2.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
					    u_xlat10_6 = texture(_LightTexture0, vs_TEXCOORD3.xy).w;
					    u_xlat0.xyz = vec3(u_xlat10_6) * u_xlat0.xyz;
					    SV_Target0.xyz = u_xlat0.xyz * _Color.www;
					    SV_Target0.w = 0.0;
					    return;
