...
namespace UnityEditor.Game.AddressableAssets
{
    ...
    public class AddressableAssetSettingsDefaultObject : ScriptableObject
    {
        ...
        /// </summary>
        public const string kDefaultConfigAssetName = "GameAssetSettings";
        /// <summary>
        /// The default folder for the serialized version of this class.
        /// </summary>
        public const string kDefaultConfigFolder = "Assets/_GameAssetsData";
        /// <summary>
        /// The name of the default config object
        /// </summary>
        public const string kDefaultConfigObjectName = "com.boqugame.addressableassets";
        ...
        public static GroupEntryCache GameGroupEntryCache
        {
            get
            {
                return AddressablesUtils.GetGroupEntryCache();
            }
        }
        ...
        public static AddressableAssetSettings GetSettings(bool create)
        {
            if (Settings == null && create)
                Settings = AddressableAssetSettings.Create(kDefaultConfigFolder, kDefaultConfigAssetName, true);
            return Settings;
        }
    }
}
