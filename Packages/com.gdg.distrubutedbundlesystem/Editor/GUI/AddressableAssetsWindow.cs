...
namespace UnityEditor.Game.AddressableAssets.GUI
{
    class AddressableAssetsWindow : EditorWindow, IHasCustomMenu
    {
        ...
        [MenuItem("AddressablesEditor/Settings", priority = 2051)]
        ...
        [MenuItem("AddressablesEditor/Groups", priority = 2050)]
        ...
        public void OnGUI()
        {
            if (AddressableAssetSettingsDefaultObject.Settings == null)
            {
                ...
                {
                    m_GroupEditor = null;
                    AddressableAssetSettingsDefaultObject.Settings = AddressableAssetSettings.Create(AddressableAssetSettingsDefaultObject.kDefaultConfigFolder, AddressableAssetSettingsDefaultObject.kDefaultConfigAssetName, true);
                }
                ...
                GUILayout.Label("Click the \"Create\" button above. Once you begin, the Addressables system will save some assets to your project to keep up with its data");
                GUILayout.Space(50);
